    ...
    render() {
        return (
            <div className="puzzleBox sumPB">
              <h4> Sum </h4>
              <input className="inputLine" type="number" onChange={ (el) => this.updateNum1(el.target.value) }/>
              <input className="inputLine" type="number" onChange={ (el) => this.updateNum2(el.target.value) }/>
